...
export default function Settings({
  ...
  return (
    ...
    >
      <div
        className="lex-settings-dialog flex h-[646px] max-h-[85vh] w-full max-w-[720px] flex-col overflow-hidden rounded-xl border border-hairline bg-white lex-card-enter"

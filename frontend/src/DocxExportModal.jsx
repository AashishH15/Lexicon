        ...
        <div className="lex-scroll min-h-0 flex-1 overflow-y-auto px-6 py-5">
          <label className="block">
            ...
            <input
              ...
              placeholder="Lex"
              className="mt-1 w-full rounded-lg border border-hairline bg-white px-3 py-2 font-sans text-sm text-ink outline-none transition-colors placeholder:text-muted/60 focus:border-ink"
            />
